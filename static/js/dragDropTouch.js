...
(function (dragDropTouch1) {
  ...
  dragDropTouch1.DataTransfer = DataTransfer
  /**
  ...
  var DragDropTouch = (function () {
    ...
    function DragDropTouch () {
      ...
      if ('ontouchstart' in document) {
        var d = document
        var ts = this._touchstart.bind(this)
        var tm = this._touchmove.bind(this)
        var te = this._touchend.bind(this)
    ...
    DragDropTouch.prototype._touchstart = function (e) {
      // Ignore entirely if the data attribute is set
  ...
  dragDropTouch1.DragDropTouch = DragDropTouch
